...
export const TokenImages: React.FC = () => {
  ...
  return (
    <Flex flexWrap="wrap">
      {tokens.map((token) => {
        const src = `https://metswap.finance/images/tokens/${token.address[381931]}.png`;
  ...
  return (
    <Flex flexWrap="wrap">
      {tokens.map((token) => {
        ...
        const primarySrc = `https://metswap.finance/images/tokens/${token.address[381931]}.png`;
        const secondarySrc = `https://metswap.finance/images/tokens/${tokens[randomTokenIndex].address[381931]}.png`;
