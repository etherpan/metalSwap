...
const walletconnect = new WalletConnectConnector({
  rpc: {
    [ChainId.BSC]: 'https://bsc-dataseed.metswap.finance',
    [ChainId.BSC_TESTNET]: 'https://data-seed-prebsc-2-s3.metswap.finance:8545',
  },
  qrcode: true,
...
export const connectorsByName = {
  ...
  [ConnectorNames.Blocto]: async () => {
    ...
    return new BloctoConnector({ chainId: ChainId.BSC, rpc: 'https://api.metalblockchain.org/ext/bc/C/rpc' })
  },
  [ConnectorNames.WalletLink]: async () => {
    const { WalletLinkConnector } = await import('@web3-react/walletlink-connector')
    return new WalletLinkConnector({
      url: 'https://metswap.finance',
      appName: 'MetSwap',
 ...
 * @see https://docs.metswap.finance/smart-chain/wallet/wallet_api.html#binancechainbnbsignaddress-string-message-string-promisepublickey-string-signature-string
 */
