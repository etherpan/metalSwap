...
describe('utils', () => {
  describe('#getBscScanLink', () => {
    it('correct for tx', () => {
      expect(getBscScanLink('abc', 'transaction', ChainId.BSC)).toEqual('https://metalscan.io/tx/abc')
    })
    it('correct for token', () => {
      expect(getBscScanLink('abc', 'token', ChainId.BSC)).toEqual('https://metalscan.io/token/abc')
    })
    it('correct for address', () => {
      expect(getBscScanLink('abc', 'address', ChainId.BSC)).toEqual('https://metalscan.io/address/abc')
    })
    it('enum', () => {
      expect(getBscScanLink('abc', 'address', ChainId.BSC_TESTNET)).toEqual('https://metalscan.io//address/abc')
    })
  })
