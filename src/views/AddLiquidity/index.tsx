...
export default function AddLiquidity() {
  ...
  const [currencyIdA, currencyIdB] = router.query.currency || ['METAL', MET[chainId]?.address]
  ...
  async function onZapIn() {
    ...
    if (rebalancing) {
      ...
      summary = `Zap in ${parsedAmounts[zapIn.swapTokenField]?.toSignificant(3)} METAL for ${getLPSymbol(
        pair.token0.symbol,
        pair.token1.symbol,
      )}`
