...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and MET pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and MET pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from MET pool', data)
  }
