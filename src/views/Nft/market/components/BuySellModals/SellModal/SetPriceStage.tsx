...
const SetPriceStage: React.FC<SetPriceStageProps> = ({
  ...
  const { tooltip, tooltipVisible, targetRef } = useTooltip(
    <>
      <Text>
        {t(
          'When selling NFTs from this collection, a portion of the METAL paid will be diverted before reaching the seller:',
        )}
      </Text>
    ...
    <>
      ...
      <GreyedOutContainer>
        ...
        {priceIsOutOfRange && (
          <Text fontSize="12px" color="failure">
            {t('Allowed price range is between %minPrice% and %maxPrice% WMETAL', {
              minPrice: MIN_PRICE,
              maxPrice: MAX_PRICE,
            })}
          </Text>
      ...
      <Grid gridTemplateColumns="32px 1fr" p="16px" maxWidth="360px">
        ...
        <Box>
          ...
          <Text small color="textSubtle">
            {t('Sales are in WMETAL. You can swap WMETAL to METAL 1:1 for free with MetSwap.')}
          </Text>
        </Box>
      </Grid>
      <Divider />
