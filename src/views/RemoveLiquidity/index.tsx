...
export default function RemoveLiquidity() {
  ...
  async function onRemove() {
    ...
    // we have a signature, use permit versions of remove liquidity
      ...
      console.log('debug BBB', oneCurrencyIsBNB, signatureData.deadline)
      if (oneCurrencyIsBNB) {
    ...
    console.log('debug indexOfSuccessfulEstimation', safeGasEstimates, 'safeGasEstimates', indexOfSuccessfulEstimation)
                  ...
                  {chainId && (oneCurrencyIsWCLD || oneCurrencyIsBNB) ? (
                    <RowBetween style={{ justifyContent: 'flex-end', fontSize: '14px' }}>
                      {oneCurrencyIsBNB ? (
                        ...
                        <StyledInternalLink
                          href={`/remove/${
                            currencyA && currencyEquals(currencyA, WNATIVE[chainId]) ? 'METAL' : currencyIdA
                          }/${currencyB && currencyEquals(currencyB, WNATIVE[chainId]) ? 'METAL' : currencyIdB}`}
                        >
                          {t('Receive METAL')}
                        </StyledInternalLink>
                      ) : null}
