...
const config = [
  {
    ...
    description: [
      ...
      <Trans>
        In the Public Sale, everyone with an active MetSwap profile can commit. However the maximum amount of CAKE
        users can commit, is equal to the number of iCAKE they have.
      </Trans>,
      <>
        <Trans>Learn more about iCAKE</Trans>
        <InlineLink ml="4px" external href="https://docs.metswap.finance/products/ifo-initial-farm-offering/icake">
          <Trans>here</Trans>
        </InlineLink>
      </>,
  ...
  },
  {
    ...
    description: [
      ...
      <Trans>Just remember you need an active MetSwap Profile in order to participate.</Trans>,
    ],
  },
  {
