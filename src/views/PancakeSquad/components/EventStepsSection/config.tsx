  ...
  return [
    {
      ...
      bodyText: [t('You’ll need an active MetSwap Profile to buy Minting Tickets and mint a Pancake Squad NFT!')],
      buttons: (
        <>
    ...
    },
    {
      ...
      title: t('Hold CAKE'),
      bodyText: [t('Each NFT costs CAKE to mint. Remember you also need METAL to cover transaction fees too!')],
      buttons: (
        <>
          <Button
            as="a"
            href="/swap?outputCurrency=0xA0d5AcCE36Fc102c57Cd65C7b88ecC46A156dDA6"
            target="_blank"
            width="100%"
          >
            {t('Buy MET')}
