  ...
  const farmsList = useCallback(
    (farmsToDisplay: DeserializedFarm[]): FarmWithStakedValue[] => {
      let farmsToDisplayWithAPR: FarmWithStakedValue[] = farmsToDisplay.map((farm) => {
        ...
        const { metRewardsApr, lpRewardsApr } = isActive
          ? getFarmApr(
          ...
          : { metRewardsApr: 0, lpRewardsApr: 0 }

        return { ...farm, apr: metRewardsApr, lpRewardsApr, liquidity: totalLiquidity }
      })
  ...
  return (
    <FarmsContext.Provider value={{ chosenFarmsMemoized }}>
      ...
      <Page>
          ...
          <FinishedTextContainer>
            ...
            <Flex>
              ...
              <FinishedTextLink
                ...
                href="https://v1-farms.metswap.finance/farms/history"
              >
        ...
        <div ref={observerRef} />
        <StyledImage src="/images/decorations/3dpan.png" alt="Pancake illustration" width={273} height={200} />
      </Page>
