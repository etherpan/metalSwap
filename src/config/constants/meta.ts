...
export const DEFAULT_META: PageMeta = {
  title: 'MetSwap',
  description:
    'The most popular AMM on metalScan by user count! Earn MET through yield farming or win it in the Lottery, then stake it in Syrup Pools to earn more tokens! Initial Farm Offerings (new token launch model pioneered by MetSwap), NFTs, and more, on a platform you can trust.',
  image: 'https://splendorous-churros-f3cf2c.netlify.app/images/hero.png',
}
