import { ChainId, Token, WMETAL } from '@pancakeswap/sdk'

const OREO_MAINNET = new Token(
  ChainId.BSC,
  '0xA0d5AcCE36Fc102c57Cd65C7b88ecC46A156dDA6',
  18,
  'MET',
  'MetSwap',
  'https://metswap.finance/',
)

const OREO_TESTNET = new Token(
  ChainId.BSC_TESTNET,
...
export const MET = {
  [ChainId.BSC]: OREO_MAINNET,
  [ChainId.BSC_TESTNET]: OREO_TESTNET,
}

const BUSD_MAINNET = new Token(
  ChainId.BSC,
  '0x6C93C4b52425163717E580bCE4669Edd6f5A31DD',
  18,
  'BUSD',
  'Binance USD',
...
export const bscTokens = {
  wbnb: WMETAL[ChainId.BSC],
  // metal here points to the wbnb contract. Wherever the currency BNB is required, conditional checks for the symbol 'BNB' can be used
  metal: new Token(
    ChainId.BSC,
  ...
  usdt: new Token(
    ChainId.BSC,
    '0xF7e8d8e844022806a3f9A312f7551fbdFEf07aEA',
    18,
    'USDT',
    'Tether USD',
    'https://tether.to/',
...
export const bscTestnetTokens = {
  wbnb: WMETAL[ChainId.BSC_TESTNET],
  cake: OREO_TESTNET,
  busd: BUSD_TESTNET,
  syrup: new Token(
    ChainId.BSC_TESTNET,
